...
public class DrawMapFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            //failed, why?  not sure.
            return container;  //it already exists I think...
        }
        //in a fragment
        map = ((SupportMapFragment) getChildFragmentManager().findFragmentById(R.id.map3)).getMap();
        //in an activity
        ...
        if (ds != null) {
            ...
            for (Iterator<Placemark> iter=pm.iterator();iter.hasNext();) {
                ...
                //getCorr(p.coordinates), p.title, p.description)   can't use title or description in new map version... odd.
                PolygonOptions rectOptions = getCorr(p.coordinates);
                //PolygonOptions rectOptions = new PolygonOptions()
                //recOptions.add(getCorr(p.coordinates));  //done by getCorr()
